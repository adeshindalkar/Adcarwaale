<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VenueBooking.aspx.cs" Inherits="final_year_project_9662.VenueBooking" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Hyundai Venue Booking - Adcarwaale</title>
    <style>
        body {
...
<body>
    <form id="form1" runat="server">
        <div class="container">
            <div class="car-image">
                <img src="https://vehicle-images.dealerinspire.com/stock-images/chrome/2f218814979a17f41c80b1840e318c0a.png" alt="Hyundai Venue" />
            </div>
            <div class="car-details">
                <h2>Hyundai Venue</h2>
                <p><strong>Engine:</strong> 1.2L Petrol</p>
                <p><strong>Power:</strong> 118 bhp</p>
